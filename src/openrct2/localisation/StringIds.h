...
// 5766 is unused
    ...
    STR_TILE_INSPECTOR_TERRAIN_EDGE_BRICK = 6382,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_IRON = 6383,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_GREY = 6384,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_YELLOW = 6385,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_RED = 6386,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_PURPLE = 6387,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_GREEN = 6388,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_STONE_BROWN = 6389,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_STONE_GREY = 6390,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_SKYSCRAPER_A = 6391,
    STR_TILE_INSPECTOR_TERRAIN_EDGE_SKYSCRAPER_B = 6392,
