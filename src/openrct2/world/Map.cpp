...
void map_reorganise_elements()
{
    ...
    TileElement* new_tile_elements = static_cast<TileElement*>(malloc(MAX_TILE_ELEMENTS * sizeof(TileElement)));
    ...
    std::memset(gTileElements + num_elements, 0, (MAX_TILE_ELEMENTS - num_elements) * sizeof(TileElement));
...
bool map_check_free_elements_and_reorganise(int32_t numElements)
{
    if (numElements != 0)
    {
        auto tileElementEnd = &gTileElements[MAX_TILE_ELEMENTS - 1];
