...
// clang-format off
constexpr const RideTypeDescriptor ClassicStandUpRollerCoasterRTD =
{
    ...
    SET_FIELD(TrackPaintFunction, GetTrackPaintFunctionClassicStandUpRC),
    ...
    SET_FIELD(Naming, { STR_RIDE_NAME_CLASSIC_STAND_UP_ROLLER_COASTER, STR_RIDE_DESCRIPTION_CLASSIC_STAND_UP_ROLLER_COASTER }),
    SET_FIELD(NameConvention, { RideComponentType::Train, RideComponentType::Track, RideComponentType::Station }),
    SET_FIELD(EnumName, nameof(RIDE_TYPE_CLASSIC_STAND_UP_ROLLER_COASTER)),
    ...
    SET_FIELD(Name, "classic_stand_up_rc"),
