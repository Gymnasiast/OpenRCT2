...
enum
{
    ...
    SPR_RIDE_DESIGN_PREVIEW_CLASSIC_WOODEN_ROLLER_COASTER_TRACK = SPR_CSG_BEGIN + 54744,
    SPR_RIDE_DESIGN_PREVIEW_CLASSIC_WOODEN_ROLLER_COASTER_SUPPORTS = SPR_CSG_BEGIN + 54745,
