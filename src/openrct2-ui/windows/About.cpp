...
static void window_about_rct2_paint(rct_window* w, rct_drawpixelinfo* dpi)
{
    ...
    // Credits
    DrawTextBasic(dpi, screenCoords, STR_COPYRIGHT_CS, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight + 74;
    DrawTextBasic(dpi, screenCoords, STR_DESIGNED_AND_PROGRAMMED_BY_CS, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight;
    DrawTextBasic(dpi, screenCoords, STR_GRAPHICS_BY_SF, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight;
    DrawTextBasic(dpi, screenCoords, STR_SOUND_AND_MUSIC_BY_AB, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight;
    DrawTextBasic(dpi, screenCoords, STR_ADDITIONAL_SOUNDS_RECORDED_BY_DE, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight + 3;
    DrawTextBasic(dpi, screenCoords, STR_REPRESENTATION_BY_JL, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += 2 * lineHeight + 5;
    DrawTextBasic(dpi, screenCoords, STR_THANKS_TO, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight;
    DrawTextBasic(dpi, screenCoords, STR_THANKS_TO_PEOPLE, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += 2 * lineHeight + 5;
    DrawTextBasic(dpi, screenCoords, STR_LICENSED_TO_INFOGRAMES_INTERACTIVE_INC, {}, COLOUR_BLACK, TextAlignment::CENTRE);
