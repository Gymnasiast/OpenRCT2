...
public:
    ...
    void OnDraw(rct_drawpixelinfo& dpi) override
    {
        ...
        if (!(gParkFlags & PARK_FLAGS_NO_MONEY))
        {
            ...
            {
                DrawTextBasic(
                    &dpi, screenCoords, STR_RAISE_COST_AMOUNT, &gWaterToolRaiseCost, COLOUR_BLACK, TextAlignment::CENTRE);
            }
            screenCoords.y += 10;
            ...
            {
                DrawTextBasic(
                    &dpi, screenCoords, STR_LOWER_COST_AMOUNT, &gWaterToolLowerCost, COLOUR_BLACK, TextAlignment::CENTRE);
            }
        }
    }
