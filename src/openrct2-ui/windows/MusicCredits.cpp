...
static void window_music_credits_scrollpaint(rct_window* w, rct_drawpixelinfo* dpi, int32_t scrollIndex)
{
    ...
    {
        DrawTextBasic(dpi, screenCoords, music_credits[i], {}, COLOUR_BLACK, TextAlignment::CENTRE);
        screenCoords.y += lineHeight;
    }

    // Add 4 more space before "Original recordings ...".
    screenCoords.y += 4;
    DrawTextBasic(dpi, screenCoords, STR_MUSIC_ACKNOWLEDGEMENTS_ORIGINAL_RECORDINGS, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    screenCoords.y += lineHeight;
    ...
    {
        DrawTextBasic(dpi, screenCoords, music_credits_rct2[i], {}, COLOUR_BLACK, TextAlignment::CENTRE);
        screenCoords.y += lineHeight;
    }
}
