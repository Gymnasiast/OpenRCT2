...
static void window_footpath_paint(rct_window* w, rct_drawpixelinfo* dpi)
{
    ...
    if (!(w->disabled_widgets & (1 << WIDX_CONSTRUCT)))
    {
        ...
        DrawTextBasic(dpi, screenCoords, STR_BUILD_THIS, {}, COLOUR_BLACK, TextAlignment::CENTRE);
    }
    ...
    if (_window_footpath_cost != MONEY32_UNDEFINED)
    {
        ...
        {
            DrawTextBasic(dpi, screenCoords, STR_COST_LABEL, &_window_footpath_cost, COLOUR_BLACK, TextAlignment::CENTRE);
        }
    }
}
